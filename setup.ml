...
(* OASIS_START *)
(* DO NOT EDIT (digest: fb4fbdab4d9037691cf7a53dde671ecf) *)
(*
...
let setup_t =
  {
                      ...
                      (OASISExpr.EBool true,
                        ("ocamlbuild",
                          [
                             ...
                             "lib";
                             "-pkgs";
                             "oUnit,Unix,compiler-libs.common";
                             "\\\n-cflags";
                             "'-ppx";
                             "$ppx_shell'";
          ...
          install_custom =
            {
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("$ocamlfind", ["install"; "ppx_shell"; "lib/META"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          uninstall_custom =
            {
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("$ocamlfind", ["remove"; "ppx_shell"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          clean_custom =
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_shell.ml"});
               Test
                 ({
                     cs_name = "test_ppx_shell";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      test_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ppx_getenv"
                        ]
                   })
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "`\151òº\021ÑÆMRYÌ+à~Ç]";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
